...
FPCV="3.2.2"
SRC_URI="ftp://ftp.freepascal.org/pub/fpc/dist/3.2.2/source/fpc-${FPCV}.source.tar.gz
	ftp://ftp.freepascal.org/pub/fpc/dist/3.2.2/source/fpcbuild-${FPCV}.tar.gz
	amd64? ( ftp://ftp.freepascal.org/pub/fpc/dist/3.2.2/x86_64-linux/fpc-${FPCV}.x86_64-linux.tar )
	x86? ( ftp://ftp.freepascal.org/pub/fpc/dist/3.2.2/i386-linux/fpc-${FPCV}.i386-linux.tar )"
...
set_pp() {
	...
	case ${1} in
		bootstrap)	pp="${WORKDIR}"/lib/fpc/${FPCV}/ppc${FPC_ARCH} ;;
